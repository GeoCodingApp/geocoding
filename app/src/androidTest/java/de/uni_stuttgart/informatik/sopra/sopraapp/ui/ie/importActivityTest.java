...
public class importActivityTest {
    @Rule
    public ActivityTestRule<importActivity> mActivityTestRule = new ActivityTestRule<>(importActivity.class, false, false);
    ...
    public void testIntent() {
        ...
        intent.setDataAndType(uriToFile, "application/zip");
        intent.putExtra("uri", uriToFile);
        intent.putExtra(Intent.EXTRA_STREAM, uriToFile);
        intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
        intent.setFlags(Intent.FLAG_GRANT_PERSISTABLE_URI_PERMISSION);
        intent.setFlags(FLAG_ACTIVITY_NEW_TASK);
        mActivityTestRule.launchActivity(intent);
        onView(withId(R.id.s_msg)).check(matches(withText("event imported successfully!")));
        // test event
    ...
    Uri initExportFile() {
        ...
        return FileProvider.getUriForFile(context, "de.uni_stuttgart.informatik.sopra.sopraapp.provider", file);
    }
}